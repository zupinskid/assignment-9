...
class RadiobuttonDemo(EasyFrame):
    ...
    def __init__(self):
        ...
        self.meatGroup = self.addRadiobuttonGroup(1, 0, rowspan=2)
        ...
        self.taterGroup = self.addRadiobuttonGroup(1, 1, rowspan = 2)
        ...
        self.vegGroup = self.addRadiobuttonGroup(1, 2, rowspan = 2)
